...
@api.get('/slides/{global_slide_id}/thumbnail/max_size/{max_x}/{max_y}', responses=ImageResponses, response_class=StreamingResponse)
...
@api.get('/slides/{global_slide_id}/label', responses=ImageResponses, response_class=StreamingResponse)
def get_slide_label(
    global_slide_id: str, 
    image_format: str = ImageFormatsQuery,
    image_quality: int = ImageQualityQuery):
...
@api.get('/slides/{global_slide_id}/macro', responses=ImageResponses, response_class=StreamingResponse)
def get_slide_macro(
    global_slide_id: str, 
    image_format: str = ImageFormatsQuery,
    image_quality: int = ImageQualityQuery):
...
@api.get('/slides/{global_slide_id}/tile/level/{level}/tile/{tile_x}/{tile_y}', responses=ImageResponses, response_class=StreamingResponse)
def get_slide_tile(
    global_slide_id: str, 
    level: int = Path(None, ge=0, example=0, description="Pyramid level of region"), 
