...
def main():
    default_port = 8080
    default_mapper_address = f'http://localhost:{default_port}/slides/' + '{global_slide_id}'
    ...
    set_env_from_args(args.port, args.data_dir, args.mapper_address, args.mapper_address==default_mapper_address)
