...
docker run --network=wsi-test-network -e WEB_CONCURRENCY=$WEB_CONCURRENCY --rm -v $DATA:/data --name=wsi-service -d registry.gitlab.cc-asp.fraunhofer.de:4567/empaia/platform/data/wsi-service
