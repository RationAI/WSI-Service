...
def test_thumbnail_cache_no_additional_memory_usage_after_first_thumbnail_request():
    for slide_id in slide_ids:
        r = requests.get(f"http://localhost:8080/v3/slides/{slide_id}/thumbnail/max_size/500/500")
...
def test_thumbnail_cache_speedup_test():
    ...
    start = time.time()
    r = requests.get("http://localhost:8080/v3/slides/8d32dba05a4558218880f06caf30d3ac/thumbnail/max_size/500/500")
